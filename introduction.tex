...
\sname{Ptahhotep} continues to lament his \indexed{old age}.

\vspace*{\fill}

7 - literally "all suns", \textit{rA} meaning "sun" and \textit{nb} used as a suffix meaning "all".
...
\begin{tabularx}{\linewidth}{cYc}
	...
	\hline \\ 
	\textbf{s} \textbf{Dr} r \textbf{n} \textbf{f} A55 &
