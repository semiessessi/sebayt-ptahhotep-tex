...
18 - It is slightly uncertain if the reading is \textit{xt} or \textit{xtw}, since the w is often absent as are the plural marks. This word occurs frequently in offering formulae. This kind of construct is called a "false plural".
...
\begin{tabularx}{\linewidth}{cYcY}
	...
	\includegraphics[scale=0.5]{word-images/1-G-2-tnw} &
	\includegraphics[scale=0.5]{word-images/1-G-3-aHa} &
	\includegraphics[scale=0.5]{word-images/1-G-4-Hmst} \\
	\hline \\ 
	\textbf{n} &
...
\sname{Ptahhotep}'s lament is complete, and...
...
\begin{tabularx}{\linewidth}{cYcYc}
	...
	\hspace*{-2mm}\includegraphics[scale=0.5]{word-images/1-G-1-n} &
	...
	\hline \\ 
	humble servant & to & orders & \hspace*{-4mm}does & staff of \indexed{old age}
\end{tabularx}

\vspace{7.5mm}

\begin{tabularx}{\linewidth}{cYcY}
	\hspace*{-1mm}\includegraphics[scale=0.5]{word-images/1-I-1-ix} &
	\hspace*{-14mm} \includegraphics[scale=0.5]{word-images/1-I-2-Ddnf} &
	\hspace*{-12mm}\includegraphics[scale=0.5]{word-images/1-I-3-mdw} &
	\hspace*{-5mm} \includegraphics[scale=0.5]{word-images/1-I-4-sDmyw} \\
	\hline \\ 
	\textbf{i} \textbf{x} Y1 &
	...
	\hline \\ 
	so that & \hspace*{-4mm} say to him & words & \hspace*{-4mm} those who listened
\end{tabularx}
