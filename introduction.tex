...
\begin{tabularx}{\linewidth}{cYcY}
	...
	\hline \\ 
	make & \indexed{old age} & to & people
\end{tabularx}
...
\begin{tabularx}{\linewidth}{cYcYc}
	...
	\hline \\ 
	orders & to & humble servant & \hspace*{-4mm}make & staff of \indexed{old age}
\end{tabularx}
...
\begin{tabularx}{\linewidth}{ccYc}
	...
	\hline \\ 
	\textit{ix} & \hspace*{-4mm} \textit{Snw} & \textit{mdw} & \textit{sDmyw} \\
	\hline \\ 
...
\begin{tabularx}{\linewidth}{ccccc}
	\hspace*{-1.5mm}\includegraphics[scale=0.5]{word-images/1-I-1-ix} &
	\hspace*{-6mm}\includegraphics[scale=0.5]{word-images/1-Q-2-irf} &
	\hspace*{-18mm}\includegraphics[scale=0.5]{word-images/1-Q-3-biA} &
	\hspace*{-14mm}\includegraphics[scale=0.5]{word-images/1-Q-4-msw} &
	\hspace*{-2mm}\includegraphics[scale=0.5]{word-images/1-Q-5-srw} \\
	\hline \\ 
	\textbf{i} \textbf{x} Y1 &
...
\begin{tabularx}{\linewidth}{cccYcc}
	\includegraphics[scale=0.5]{word-images/1-R-1-aqq} &
	\includegraphics[scale=0.5]{word-images/1-R-2-sDm} &
	\includegraphics[scale=0.5]{word-images/1-R-3-imf} &
	\includegraphics[scale=0.5]{word-images/1-R-4-mtrt} &
	\includegraphics[scale=0.5]{word-images/1-9-1-ib} &
	\includegraphics[scale=0.5]{word-images/1-R-6-nb} \\
	\hline \\ 
	\textbf{aq} q D54 &
	\textbf{sDm} m &
...
\sname{Djedkare Isesi} ends his response with some wisdom of his own.
...
\begin{tabularx}{\linewidth}{cccc}
	\includegraphics[scale=0.5]{word-images/1-S-1-Ddnf} &
	\includegraphics[scale=0.5]{word-images/1-S-2-nin} &
	\includegraphics[scale=0.5]{word-images/1-S-3-msy} &
	\includegraphics[scale=0.5]{word-images/1-S-4-sAw} \\
	\hline \\ 
