...
18 - it is slightly uncertain if the reading is \textit{xt} or \textit{xtw}, since the w is often absent as are the plural marks, yet the interpretation is clearly plural. This word occurs frequently in offering formulae.
...
\begin{tabularx}{\linewidth}{cYcY}
	...
	\textbf{b} \textbf{i} \textbf{n} wr &
	\textbf{m} &
	\textbf{x} \textbf{t} Y1 \textbf{Z2}\ssn{17} &
	\textbf{nb} \textbf{t} \\
	\hline \\ 
	\textit{bin} & \textit{m} & \textit{xtw}\ssn{18} & \textit{nbt} \\
	\hline \\ 
	evil & in & things & all
\end{tabularx}
