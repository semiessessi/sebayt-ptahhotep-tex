%% packages
%\usepackage[utf8]{inputenc} % must come early.
...
\newcommand\eayin{{\egyptologyfont\symbol{"A725}}}
\newcommand\ealeph{{\egyptologyfont\symbol{"A723}}}
...
\newunicodechar{^^^^a723}{\ealeph} % aleph
\newunicodechar{^^^^a725}{\eayin} % ayin
\newunicodechar{^^^^1e0f}{\b{d}} % dj
\newunicodechar{^^^^a7bd}{\`{i}} % yod
\newunicodechar{^^^^1e6f}{\b{t}} % tch
\newunicodechar{^^^^1e2b}{\b{h}} % x
\newunicodechar{^^^^1e96}{\U{h}} % X
\newunicodechar{^^^^1e25}{\d{h}} % H
...
%this screws up the interlinears
